...
import { DetaljertVedtaksperiodeRadBoutgifter3 } from './DetaljertVedtaksperiodeRadBoutgifter';
...
export const VedtaksperioderOversiktBoutgifter3: React.FC<Props> = ({ vedtaksperioder }) => {
        ...
        <Table size={'small'}>
            ...
            <Table.Body>
                {vedtaksperioder.map((periode) => {
                    return (
                        <DetaljertVedtaksperiodeRadBoutgifter3
                            key={periode.fom}

...
import { AktivitetDelvilkårReiseTilSamlingTso } from './Delvilkår/AktivitetDelvilkårReiseTilSamlingTso';
import { DetaljerRegisterAktivitet } from './DetaljerRegisterAktivitet';
import styles from './EndreAktivitetReiseTilSamlingTso.module.css';
...
import {
    ...
    nyAktivitet,
    resettAktivitet,
} from './utilsReiseTilSamlingTso';
import { AktivitetValidering, validerAktivitet } from './valideringAktivitetReiseTilSamlingTso';
...
export const EndreAktivitetReiseTilSamlingTso: React.FC<{
    ...
    const [form, settForm] = useState<EndreAktivitetFormReiseTilSamlingTso>(
    ...
    const oppdaterForm = (key: keyof AktivitetReiseTilSamlingTso, nyVerdi: string) => {
    ...
    return (
        <ResultatOgStatusKort periode={aktivitet} redigeres>
            <VStack gap={'space-16'}>
                <div className={styles.feltContainer}>
                    <EndreTypeOgDatoer
                        ...
                        typeOptions={valgbareAktivitetTyper(Stønadstype.REISE_TIL_SAMLING_TSO)}
            ...
            <AktivitetDelvilkårReiseTilSamlingTso
                aktivitetForm={form}
                oppdaterLønnet={(svar) =>

...
const gjenlevende =
    'Dersom omstillingsstønad er gitt etter unntaksreglene i § 17-3 andre ledd, kan tilleggsstønader ikke gis fordi medlemskapsvilkåret ikke er oppfylt. Du må derfor innhente medlemskapsstatus fra Nav Familie og pensjonsytelser. ' +
    'Hvis det utbetales gjenlevendepensjon, må du også innhente medlemskapsstatus fra Nav Familie og pensjonsytelser.  ' +
    'Hvis søker er gjenlevende, men ikke mottar gjenlevendepensjon, må du må først vurdere om søker er medlem i et annet lands trygdeordning (lovvalg). Dersom søker ikke er medlem i et annet land, må du vurder om vilkårene i folketrygdloven kapittel 2 er oppfylt. Se rundskriv til kapittel 2.';

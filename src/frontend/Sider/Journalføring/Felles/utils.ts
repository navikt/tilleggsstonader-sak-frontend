...
export const alleBehandlingerErFerdigstiltEllerSattPåVent = (behandlinger: KlageBehandling[]) =>
    behandlinger.every(
        (behandling) =>
...
export const utledBehandlingstype = (tidligereBehandlinger: KlageBehandling[]): BehandlingType => {
